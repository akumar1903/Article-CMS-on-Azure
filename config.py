...
class Config(object):
    ...
    SQL_SERVER = os.environ.get('SQL_SERVER') or 'udacityarticlecms.database.windows.net'
    ...
    "mssql+pyodbc://udacityadmin:@"
    "udacityarticlecms.database.windows.net:1433/udacityarticlecms"
